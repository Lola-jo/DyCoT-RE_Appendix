...
with full code released and interactive visualizations available on the project website.\footnote{
...
All experiments use Proximal Policy Optimization from Stable-Baselines3, with hyperparameters summarized in Table~\ref{tab:env_settings}.
...
\begin{figure}[t]
\centering
\includegraphics[width=0.48\textwidth]{Figures/reward_episode_curve_2.pdf}
...
For BipedalWalker, which demands coordinated multi-joint control under sparse and noisy feedback, DyCoT-RE yields smoother learning curves and higher terminal rewards.
Its structured reward decomposition likely facilitates learning stable locomotion by explicitly disentangling balance and propulsion objectives.
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.48\textwidth]{Figures/bar_comparison_5.pdf}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.48\textwidth]{Figures/cot_ablation_1.pdf}
